...
ITEM_TYPE_CACHE_FILE = "public/data/item_type_cache.json"
...
def get_months_to_reprocess(index_file, current_month):
    ...
    for m in months:
        ...
        if months_ago > LOOKBACK_MONTHS:
            continue
        data_file = f"public/data/{m}.json"
...
def main():
    ...
    prev_months = get_months_to_reprocess("public/data/index.json", month_str)
    ...
    for m in all_months:
        ...
        month_file = f"public/data/{m}.json"
    ...
    months = update_index("public/data/index.json", month_str)
    print(f"\nWrote public/data/index.json — available months: {months}")
